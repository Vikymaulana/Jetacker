...
from hiwonder_interfaces.srv import SetColorDetectParam
...
class VoiceControlColorDetectNode:
    def __init__(self, name):
        ...
        while not rospy.is_shutdown():
            try:
                if rospy.get_param('/xf_asr_offline_node/init_finish') and rospy.get_param('/color_detect/init_finish'):
                    break
            except:
                rospy.sleep(0.1)
        self.play('running')
